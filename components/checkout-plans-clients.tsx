...
import { CheckCircle, Crown, Gift, Zap } from "lucide-react";
...
const clientPlans = [
  {
    ...
    features: [
      "Fotos com blur",
      "Acesso limitado a perfis",
      "Sem contato direto com modelos",
    ],
    isPopular: false,
    theme: "basic",
  },
  ...
  },
  {
    ...
    features: [
      ...
      "Desconto anual (economize R$799)",
...
export function CheckoutPlansClients() {
    ...
    <section className="bg-dark-950 py-20 text-white">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h1 className="text-5xl font-extrabold mb-4 gradient-text">Planos para Clientes</h1>
          <p className="text-xl text-gray-400">
            Escolha o plano ideal para uma experiência premium e sem limites na Spicy Models.
          </p>
        </div>
